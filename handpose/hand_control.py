...
gameScreen = {'top': 360, 'left': -screenWidth/2, 'width': screenWidth/2, 'height': round(2/3 *screenHeight)}
    ...
    if results.multi_hand_landmarks:
      for hand_landmarks in results.multi_hand_landmarks:
        ...
        for hand_landmarks in results.multi_hand_landmarks:
            ...
            real_x = x/image_width*gameScreen['width']
            real_y = y/image_height*gameScreen['height']
            moveMouse(real_x,real_y)
            win32api.mouse_event(win32con.MOUSEEVENTF_LEFTDOWN,0, 0, 0, 0)
            #move mouse
            #letdown
